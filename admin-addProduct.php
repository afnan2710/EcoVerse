...
<div class="container pl-12 pt-5">
    ...
    <form method="POST" class=" card bg-base-100 shadow-xl h-full p-10">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2" id="image_url" name="image_url">
        </div>
        <div class="mb-3">
    ...
    <form method="POST" class=" card bg-base-100 shadow-xl h-full p-10">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control input input-bordered w-full max-w-xs mt-2" id="update_name" name="update_name">
        </div>
        </div>
        <div class="flex gap-9">
        <div class="mb-3">
            <label for="update_description" class="form-label">New Description</label>
            <textarea class="form-control input input-bordered w-full max-w-xs mt-2" id="update_description" name="update_description"></textarea>
        </div>
        <div class="mb-3">
            <label for="update_price" class="form-label">New Price</label>
            <input type="number" step="0.01" class="form-control input input-bordered w-full max-w-xs mt-2" id="update_price" name="update_price">
        </div>
        </div>
        <div class="flex gap-5">
        <div class="mb-3">
            <label for="update_image_url" class="form-label">New Image URL</label>
            <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2" id="update_image_url" name="update_image_url">
        </div>
        <div class="mb-3">
            ...
            <div class="card w-96 bg-base-100 shadow-xl mt-10">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions flex items-center justify-between">
                        ...
                        <a href="admin-addProduct.php?delete=<?= $row['product_id']; ?>" class="btn btn-error">Delete</a>
                    </div>
                </div>
            </div>
        <?php endwhile; ?>
